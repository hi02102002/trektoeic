			...
			<div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
				...
				<div className="mb-12 rounded-lg border border-border bg-card p-8">
					<div className="mx-auto max-w-2xl text-center">
						<h3 className="mb-2 font-bold text-2xl">Stay updated</h3>
						...
						<form className="mx-auto flex max-w-md gap-2">
							...
							/>
							<button className="whitespace-nowrap rounded-md bg-primary px-6 py-2 text-primary-foreground transition-colors hover:bg-primary/90">
								Subscribe
							</button>
						</form>
					</div>
