	...
	return (
		...
		>
			...
			<section className="space-y-4">
				...
				<div className="grid grid-cols-2 gap-4">
					<div>
						...
						/>
						{errors.firstName && (
							<span role="alert" className="mt-1 block text-red-600 text-sm">
				...
				<div>
					<label htmlFor="phone" className="mb-1 block font-medium text-sm">
						Phone (Optional)
					</label>
					<input
						id="phone"
			...
			<section className="space-y-4">
				...
				<div>
					<label htmlFor="street" className="mb-1 block font-medium text-sm">
						Street *
					</label>
					<input
						id="street"
				...
				<div className="grid grid-cols-2 gap-4">
					<div>
						<label htmlFor="city" className="mb-1 block font-medium text-sm">
							City *
						</label>
						<input
							id="city"
					...
					<div>
						<label htmlFor="state" className="mb-1 block font-medium text-sm">
							State *
						</label>
						<input
							id="state"
				...
				<div className="grid grid-cols-2 gap-4">
					<div>
						<label htmlFor="zipCode" className="mb-1 block font-medium text-sm">
							ZIP Code *
						</label>
						<input
							id="zipCode"
					...
					<div>
						<label htmlFor="country" className="mb-1 block font-medium text-sm">
							Country *
						</label>
						<input
							id="country"
			...
			<section className="space-y-4">
				...
				<div>
					<label htmlFor="skills" className="mb-1 block font-medium text-sm">
			...
			<section className="space-y-4">
				...
				{isStudent && (
					<div>
						<label htmlFor="school" className="mb-1 block font-medium text-sm">
							School Name *
						</label>
						<input
							id="school"
			...
			<section className="space-y-4">
				...
				{errors.agreedToTerms && (
					<span role="alert" className="block text-red-600 text-sm">
