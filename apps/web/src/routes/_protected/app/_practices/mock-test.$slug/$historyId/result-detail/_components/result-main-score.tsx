		...
		<div className="relative overflow-hidden bg-white p-4 text-center">
			...
			<div className="relative z-10">
				...
				<div className="mb-2 font-semibold text-6xl text-neutral-900 tracking-tighter">
					...
					<span className="font-normal text-2xl text-neutral-400"> / 990</span>
				</div>
				<div className="mb-4 grid grid-cols-2 gap-2">
					<div className="rounded-lg border border-neutral-100 bg-neutral-50 p-2">
						<div className="mb-1 text-neutral-500 text-xs">Listening</div>
						<div className="font-semibold text-lg text-neutral-900">
							{history.metadata.listeningScore ?? 0}
						</div>
					</div>
					<div className="rounded-lg border border-neutral-100 bg-neutral-50 p-2">
						<div className="mb-1 text-neutral-500 text-xs">Reading</div>
						<div className="font-semibold text-lg text-neutral-900">
				...
				<div className="space-y-3">
					<div className="flex items-center justify-between text-sm">
						<span className="text-neutral-500">Độ chính xác</span>
					...
					<div className="flex items-center justify-between text-sm">
						...
						<span className="font-medium text-neutral-900">
							...
							{history.metadata.numberOfQuestions ?? 0} câu
						</span>
					</div>
					...
					<div className="flex items-center justify-between text-xs">
						<div className="flex items-center gap-1">
							...
							<span className="text-neutral-500">
								Đúng ({history.metadata.numberOfCorrectQuestions ?? 0})
							</span>
						</div>
						<div className="flex items-center gap-1">
							<div className="h-2 w-2 rounded-full bg-red-500" />
							<span className="text-neutral-500">
								Sai ({history.metadata.numberOfWrongQuestions ?? 0})
							</span>
						</div>
						<div className="flex items-center gap-1">
							<div className="h-2 w-2 rounded-full bg-neutral-300" />
							<span className="text-neutral-500">
								Bỏ qua ({history.metadata.numberOfUnansweredQuestions ?? 0})
							</span>
						</div>
					</div>
				</div>
